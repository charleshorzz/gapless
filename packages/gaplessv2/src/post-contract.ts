...
export function handleChatHistoryStored(event: ChatHistoryStored): void {
  ...
  //
  // - contract.chatRequests(...)
  // - contract.chatSessions(...)
  // - contract.getChatHistory(...)
  // - contract.owner(...)
  // - contract.postCount(...)
  // - contract.posts(...)
  // - contract.reputation(...)
...
export function handleChatRequested(event: ChatRequested): void {}
